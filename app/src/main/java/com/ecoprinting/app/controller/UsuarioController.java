...
public class UsuarioController {
    ...
    public String editarUsuario(@PathVariable("id") int id, Model model) {
        ...
        UsuarioDTO usuarioDTO = new UsuarioDTO();
        usuarioDTO.setId(1);
        usuarioDTO.setNome("Joao da Silva");
        usuarioDTO.setEmail("joao@gmail.com");
        usuarioDTO.setCpf("12345678900");
        usuarioDTO.setDataNascimento(new Date(2024, 1, 1));
